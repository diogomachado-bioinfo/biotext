...
def encode_string(input_string,detail=''):
    """
...
def decode_string(input_string,detail=''):
    """
...
def encode_list(string_list, detail='', verbose=False):
    """
...
def decode_list(input_list,detail='',verbose=False):
    """
